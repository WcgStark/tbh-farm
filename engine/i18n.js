...
;(function (g) {
 ...
 live: 'live', reconnecting: 'reconnecting…', waiting: 'waiting', demo_mode: 'demo',
 ...
 live: 'ao vivo', reconnecting: 'reconectando…', waiting: 'aguardando', demo_mode: 'demo',
 ...
 live: 'en vivo', reconnecting: 'reconectando…', waiting: 'esperando', demo_mode: 'demo',
 ...
 live: 'en direct', reconnecting: 'reconnexion…', waiting: 'en attente', demo_mode: 'démo',
 ...
 live: 'live', reconnecting: 'verbinde neu…', waiting: 'warte', demo_mode: 'Demo',
 ...
 live: 'ライブ', reconnecting: '再接続中…', waiting: '待機中', demo_mode: 'デモ',
 ...
 perm_denied: '권한 거부됨',
 live: '실시간', reconnecting: '재연결 중…', waiting: '대기 중', demo_mode: '데모',
 ...
 perm_denied: '权限被拒绝',
 live: '实时', reconnecting: '重新连接中…', waiting: '等待中', demo_mode: '演示',
 ...
 perm_denied: '權限被拒絕',
 live: '即時', reconnecting: '重新連接中…', waiting: '等待中', demo_mode: '示範',
 ...
 live: 'вживую', reconnecting: 'переподключение…', waiting: 'ожидание', demo_mode: 'демо',
 ...
 comp_title: 'party composition', comp_notank: 'no tank squishy front line', comp_hastank: 'front line covered ',
 ...
 comp_title: 'composição da party', comp_notank: 'sem tank frente frágil', comp_hastank: 'linha de frente coberta ',
 ...
 const FARM = {
 'en-US': { f_level: 'level', f_stage: 'STAGE', f_clear: 'CLEAR', f_unlock: 'UNLOCK', f_surv: 'surv.', f_calfit: 'calibrated from your real times across {0} stages', f_calone: 'calibrating — farm another stage to lock in the distant ones', f_calnone: 'play a few seconds to calibrate', tab_hist: 'History', d_normal: 'Normal', d_nightmare: 'Nightmare', d_hell: 'Hell', d_torment: 'Torment', f_caledit: 'your clear times', f_caltime: 'seconds', f_caladd: 'add', f_calhint: 'enter your clear time in seconds (e.g. 400) for 2+ stages so EXP/h and Gold/h match the wiki', f_calman: 'calibrated from your {0} entered clear times', f_stages: 'STAGES', f_calneed: '1 entered — add one more stage to apply', refresh_save: 'Re-read the save now', gsl_pre: 'enable up to', gsl_off: 'all', gsl_n: 'nodes', hist_power: 'HISTORY · POWER', hist_gold: 'HISTORY · GOLD', hist_note: 'Builds up as you play.', hist_pow_sum: '{0} samples · POWER {1} → {2} ({3})', hist_gold_sum: 'gold {0} → {1}', hist_collecting: 'Collecting… leave it open while you play.', refreshed: 'Reloaded', refresh_savedat: 'save from {0}', refresh_nosync: "Out of sync? The game hasn't written its save yet." },
 'pt-BR': { f_level: 'nível', f_stage: 'ESTÁGIO', f_clear: 'CLEAR', f_unlock: 'DESTRAVAR', f_surv: 'sobrev.', f_calfit: 'calibrado pelos seus tempos reais em {0} estágios', f_calone: 'calibrando — farme outro estágio pra cravar os distantes', f_calnone: 'jogue uns segundos pra calibrar', tab_hist: 'Histórico', d_normal: 'Normal', d_nightmare: 'Pesadelo', d_hell: 'Inferno', d_torment: 'Tormento', f_caledit: 'seus tempos de clear', f_caltime: 'segundos', f_caladd: 'add', f_calhint: 'digite seu tempo de clear em segundos (ex: 400) de 2+ estágios pra EXP/h e Gold/h baterem com o wiki', f_calman: 'calibrado pelos seus {0} tempos digitados', f_stages: 'ESTÁGIOS', f_calneed: '1 adicionado — bote mais um estágio pra aplicar', refresh_save: 'Reler o save agora', gsl_pre: 'habilitar até', gsl_off: 'tudo', gsl_n: 'nós', hist_power: 'HISTÓRICO · POWER', hist_gold: 'HISTÓRICO · GOLD', hist_note: 'Acumula enquanto você joga.', hist_pow_sum: '{0} amostras · POWER {1} → {2} ({3})', hist_gold_sum: 'ouro {0} → {1}', hist_collecting: 'Coletando… deixe aberto enquanto joga.', refreshed: 'Recarregado', refresh_savedat: 'save de {0}', refresh_nosync: 'Desincronizado? O jogo ainda não salvou.' },
