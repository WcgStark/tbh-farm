...
;(function (g) {
 ...
 const FARM = {
 'en-US': { f_level: 'level', f_stage: 'STAGE', f_clear: 'CLEAR', f_unlock: 'UNLOCK', f_surv: 'surv.', f_calfit: 'calibrated from your real times across {0} stages', f_calone: 'calibrating — farm another stage to lock in the distant ones', f_calnone: 'play a few seconds to calibrate', tab_hist: 'History', d_normal: 'Normal', d_nightmare: 'Nightmare', d_hell: 'Hell', d_torment: 'Torment', f_caledit: 'your clear times', f_caltime: 'm:ss', f_caladd: 'add', f_calhint: 'enter your real clear time for 2+ stages to make EXP/h and Gold/h match the wiki exactly', f_calman: 'calibrated from your {0} entered clear times', f_stages: 'STAGES', f_calneed: '1 entered — add one more stage to apply' },
 'pt-BR': { f_level: 'nível', f_stage: 'ESTÁGIO', f_clear: 'CLEAR', f_unlock: 'DESTRAVAR', f_surv: 'sobrev.', f_calfit: 'calibrado pelos seus tempos reais em {0} estágios', f_calone: 'calibrando — farme outro estágio pra cravar os distantes', f_calnone: 'jogue uns segundos pra calibrar', tab_hist: 'Histórico', d_normal: 'Normal', d_nightmare: 'Pesadelo', d_hell: 'Inferno', d_torment: 'Tormento', f_caledit: 'seus tempos de clear', f_caltime: 'm:ss', f_caladd: 'add', f_calhint: 'digite seu tempo real de clear de 2+ estágios pra EXP/h e Gold/h baterem certinho com o wiki', f_calman: 'calibrado pelos seus {0} tempos digitados', f_stages: 'ESTÁGIOS', f_calneed: '1 adicionado — bote mais um estágio pra aplicar' },
